...
?>
    ...
    <main class="contenedor seccion contenido-centrado">
        ...
        <article class="entrada-blog">  <!-- porque son nentradas de blog-->
            <div class="imagen">
                <picture>
        ...
        <article class="entrada-blog">  <!-- porque son nentradas de blog-->
            <div class="imagen">
                <picture>
                    ...
                    <img loading="lazy" src="build/img/blog3.jpeg" alt="texto entrada blog">
                </picture>
            </div>
        ...
        <article class="entrada-blog">  <!-- porque son nentradas de blog-->
            <div class="imagen">
                <picture>
                    ...
                    <img loading="lazy" src="build/img/blog4.jpeg" alt="texto entrada blog">
                </picture>
            </div>
